 ...
 * @author Mhamdi Amar
 */
public class InscriptionChef extends javax.swing.JFrame {

    /**
     * Creates new form PropositionRecetteClient
     */
    public InscriptionChef() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Arabie saoudite", "Bahreïn", "Émirats arabes unis", "lrak", "Jordanie", "Koweït", "Liban", "Oman", "Palestine", "Qatar", "Syrie", "Yémen", "Algérie", "Égypte", "Libye", "Maroc", "Soudan", "Tunisie" }));
        ...
        jDateChooser2.setBounds(460, 220, 220, 30);
        ...
        jBT_supprimer4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sprintjava/img/parc.png"))); // NOI18N
        jBT_supprimer4.setText("Joindre CV");
        ...
        jBT_supprimer4.setBounds(510, 420, 130, 30);
        ...
        jBT_supprimer1.setBounds(660, 480, 110, 30);

        jLabel10.setFont(new java.awt.Font("DK Cool Crayon", 1, 24)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Nouveau chef");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(230, 70, 360, 30);
        ...
        jBT_supprimer9.setBounds(510, 480, 130, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InscriptionChef.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
